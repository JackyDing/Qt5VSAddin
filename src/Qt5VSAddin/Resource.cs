...
// --------------------------------------------------------------------------------------
{
    ...
    // All the constants for the LaunchAssistant command.
    public const int AssistantBitmapID = 2;
    public const string
        LaunchAssistant = "LaunchAssistant",
        LaunchAssistantFullCommand = CommandBarName + ".Connect." + LaunchAssistant;
