...
namespace Qt5VSAddin
{
    public class VSQtSettings
    {
        ...
        public void SaveSettings()
        {
            ...
            QtVSIPSettings.SaveDesignerOptions(newDesignerOptions);
            QtVSIPSettings.SaveLinguistOptions(newLinguistOptions);
            QtVSIPSettings.SaveAssistantOptions(newAssistantOptions);
