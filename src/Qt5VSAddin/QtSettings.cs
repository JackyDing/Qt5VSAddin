...
namespace Qt5VSAddin
{
    public class ProjectQtSettings
    {
        ...
        private string oldDesignerOptions = null;
        private string oldLinguistOptions = null;
        private string oldAssistantOptions = null;
        ...
        private string newDesignerOptions = null;
        private string newLinguistOptions = null;
        private string newAssistantOptions = null;
        ...
        public void SaveSettings()
        {
            ...
            if (oldDesignerOptions != newDesignerOptions)
                QtVSIPSettings.SaveDesignerOptions(project, newDesignerOptions);

            if (oldLinguistOptions != newLinguistOptions)
                QtVSIPSettings.SaveLinguistOptions(project, newLinguistOptions);

            if (oldAssistantOptions != newAssistantOptions)
                QtVSIPSettings.SaveAssistantOptions(project, newAssistantOptions);
        ...
        public string DesignerOptions
        {
            get
            {
                return newDesignerOptions;
            }
            set
            {
                newDesignerOptions = value;
            }
        }

        public string LinguistOptions
        {
            get
            {
                return newLinguistOptions;
            }
            set
            {
                newLinguistOptions = value;
            }
        }

        public string AssistantOptions
        {
            get
            {
                return newAssistantOptions;
            }
            set
            {
                newAssistantOptions = value;
            }
        }
