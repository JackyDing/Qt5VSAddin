...
namespace Digia.Qt5ProjectLib
{
    ...
    public class VersionInformation
    {
        ...
        private String Locate_qglobal_h()
        {
            ...
            throw new Qt5VSException("qglobal.h not found");
        }
        ...
        public bool is64Bit()
        {
            ...
            if (!File.Exists(fileToCheck))
                throw new Qt5VSException("Can't find " + fileToCheck);
            ...
            if (!success)
                throw new Qt5VSException("GetBinaryTypeA failed");
            ...
            throw new Qt5VSException("GetBinaryTypeA return unknown executable format for " + fileToCheck);
        }
    }
}
