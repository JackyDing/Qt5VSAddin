...
namespace Digia.Qt5ProjectLib
{
    public class QtVSIPSettings
    {
        ...
        public static string GetDesignerOptions()
        {
            return GetOption(Resources.designerOptionsKeyword);
        }

        public static string GetDesignerOptions(EnvDTE.Project project)
        {
            return GetOption(project, Resources.designerOptionsKeyword);
        }

        public static string GetLinguistOptions()
        {
            return GetOption(Resources.linguistOptionsKeyword);
        }

        public static string GetLinguistOptions(EnvDTE.Project project)
        {
            return GetOption(project, Resources.linguistOptionsKeyword);
        }

        public static string GetAssistantOptions()
        {
            return GetOption(Resources.assistantOptionsKeyword);
        }

        public static string GetAssistantOptions(EnvDTE.Project project)
        {
            return GetOption(project, Resources.assistantOptionsKeyword);
        }
        ...
        public static void SaveDesignerOptions(EnvDTE.Project project, string options)
        {
            if (options == null)
            {
                options = GetDesignerOptions();
            }
            SaveOption(project, Resources.designerOptionsKeyword, options);
        }

        public static void SaveDesignerOptions(string options)
        {
            SaveOption(Resources.designerOptionsKeyword, options);
        }

        public static void SaveLinguistOptions(EnvDTE.Project project, string options)
        {
            if (options == null)
            {
                options = GetLinguistOptions();
            }
            SaveOption(project, Resources.linguistOptionsKeyword, options);
        }

        public static void SaveLinguistOptions(string options)
        {
            SaveOption(Resources.linguistOptionsKeyword, options);
        }

        public static void SaveAssistantOptions(EnvDTE.Project project, string options)
        {
            if (options == null)
            {
                options = GetAssistantOptions();
            }
            SaveOption(project, Resources.assistantOptionsKeyword, options);
        }

        public static void SaveAssistantOptions(string options)
        {
            SaveOption(Resources.assistantOptionsKeyword, options);
        }
