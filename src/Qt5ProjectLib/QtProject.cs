...
namespace Digia.Qt5ProjectLib
{
    ...
    public class QtProject
    {
        ...
        {
            if (project == null)
                throw new Qt5VSException(SR.GetString("QtProject_CannotConstructWithoutValidProject"));
            envPro = project;
            dte = envPro.DTE;
        ...
        public void AddUic4BuildStep(VCFile file)
        {
            ...
            {
                throw new Qt5VSException(SR.GetString("QtProject_CannotAddUicStep", file.FullPath));
            }
        }
        ...
        public void RemoveMocStep(VCFile file)
        {
            ...
            {
                throw new Qt5VSException(SR.GetString("QtProject_CannotRemoveMocStep", file.FullPath));
            }
        }
        ...
        public VCFilter FindFilterFromName(string filtername)
        {
            ...
            {
                throw new Qt5VSException(SR.GetString("QtProject_CannotFindFilter"));
            }
        }
        ...
        public void AddDirectories()
        {
            ...
            {
                throw new Qt5VSException(SR.GetString("QtProject_CannotCreateResourceDir"));
            }
