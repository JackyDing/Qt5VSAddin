...
namespace Digia.Qt5ProjectLib
{
    ...
    public class HelperFunctions
    {
        ...
        static public void SetQtEnvironment(EnvDTE.Project prj, string qtDir, string solutionConfig)
        {
            VCProject vcPrj = prj.Object as VCProject;
            var propertyAccess = (IVCBuildPropertyStorage)vcPrj;
        ...
        public static bool IsVcProject(EnvDTE.Project proj)
        {
            try
            {
                if (proj != null && proj.Kind == "{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}")
                {
                    return HelperFunctions.IsVcProject(proj.Object as VCProject);
                }
            }
            catch { }
            return false;
        ...
        public static string GetSolutionPlaformName(EnvDTE.Solution solution)
        {
            if (solution != null)
            {
                SolutionConfiguration2 configuration = solution.SolutionBuild.ActiveConfiguration as SolutionConfiguration2;
        ...
        public static string GetProjectPlatformName(EnvDTE.Project project)
        {
            if (project != null)
        ...
        public static string GetTemplatePath()
        {
            ...
            {
                throw new Qt5VSException(SR.GetString("HelperFunctions_ErrorSearchForQtTemplatePath"));
            }
        }
        ...
        public static EnvDTE.Project GetSelectedQtProject(EnvDTE.DTE dteObject)
        {
            ...
            return HelperFunctions.IsQt5Project(pro) ? pro : null;
        }
